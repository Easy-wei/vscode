...
html = getHtml("http://blog.sina.com.cn/s/blog_497ccf1e0100rd87.html").decode("utf-8");
imagesUrl = getImg(html);
 
if os.path.exists("e:/code/imageDownload") == False:
    os.mkdir("e:/code/imageDownload");
...
for url in imagesUrl:
    ...
    if(url.find('.') != -1):#2
        ...
        f = open("e:/code/imageDownload/"+str(count)+name, 'wb');  #代开一个文件，准备以二进制写入文件
